"""Pytest fixtures for quotes module tests."""
import uuid
import pytest
...
from quotes.models import QuoteSeries, QuoteSettings, Quote, QuoteLine
...
@pytest.fixture
def quote_series(db, hub_id):
    """Create a test QuoteSeries."""
    return QuoteSeries.objects.create(
        hub_id=hub_id,
        name='Test Name',
        prefix='Test Prefix',
        next_number=0,
